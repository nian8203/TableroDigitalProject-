<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="docente.aspx.cs" Inherits="TableroDigitalV2.pages.docente.docente" %>
                    ...
                    <div class="content-wrapper">
                        <div class="page-header">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="docente.aspx" style="color: #de3c2f">Docentes</a></li>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9" style="color: red;">
                                                        <asp:TextBox ID="txtId" runat="server" CssClass="form-control" CausesValidation="True" MaxLength="20" Height="35px" ></asp:TextBox>
                                                        <asp:RequiredFieldValidator CssClass="form-text" ID="rfvId" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="txtId"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <asp:RequiredFieldValidator CssClass="form-text" ID="rfvNombre" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="txtNombre"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <asp:RequiredFieldValidator CssClass="form-text" ID="rfvApellido" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="txtApellido"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <asp:RequiredFieldValidator CssClass="form-text" ID="rvTelefono" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="txtTelefono"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <asp:RequiredFieldValidator CssClass="form-text" ID="rfvDireccion" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="txtDireccion"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <asp:TextBox ID="txtCorreo" runat="server" CssClass="form-control" CausesValidation="True" MaxLength="50" Height="35px" TextMode="Email" ></asp:TextBox>
                                                        <asp:RequiredFieldValidator CssClass="form-text" ID="rfvCorreo" runat="server" ErrorMessage="Campo Requerido" ControlToValidate="txtCorreo"></asp:RequiredFieldValidator>
                                                    </div>
                                                </div>
                                            </div>
                                            <%-- <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <asp:Button ID="btnCancelarForm" CssClass="btn btn-outline-dark float-right mr-3" runat="server" Text="Cancelar" />
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <asp:LinkButton ID="lbActualizarDatos" runat="server" CssClass="btn btn-outline-danger"
                                                                    Width="150" CausesValidation="True" Height="40px" Font-Size="Large"
                                                                    OnClick="lbActualizarDatos_Click">
                                                                 Actualizar
                                                                </asp:LinkButton>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Información Personal 
                                             ...
                                             <asp:LinkButton ID="lbRegistrarDocente" runat="server" CssClass="btn btn-danger float-right" Height="40"
                                                 OnClick="lbRegistrarDocente_Click">
                                           <i class="fas fa-user-plus"></i>&nbsp;&nbsp;Docente
                                             </asp:LinkButton>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row justify-content-center align-items-center table-responsive ml-1 table-borderless">
                                                <asp:GridView ID="gvListarDocentes" runat="server" CssClass="table table-hover" AllowPaging="True"
                                                    AlternatingRowStyle-BackColor=""
                                                    OnSelectedIndexChanged="gvListarDocentes_SelectedIndexChanged"
                                                    OnPageIndexChanging="gvListarDocentes_PageIndexChanging"
                                                    OnRowCommand="gvListarDocentes_RowCommand" PageSize="10"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <asp:DropDownList ID="ddlAsignaturaReg" runat="server" CssClass="form-control" Height="35px"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="staticBackdropRegistro" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabelRegistro" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                        <asp:LinkButton ID="lbCrearNuevoDocente" runat="server" CssClass="btn btn-outline-danger"
                                                            Width="150" CausesValidation="True" Height="40px" Font-Size="Large"
                                                            OnClick="lbCrearNuevoDocente_Click">
                                                                 Registrar
                                                        </asp:LinkButton>
                                                    </div>
                                                </div>
